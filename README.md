...
The annual CTF had historically been a small in-person college event. The 2021 edition moved to the cloud out of COVID necessity, deployed via a sequence of bash bring-up scripts.

As cloud infrastructure engineer for the 2022 edition, I built out a Terraform and Helm deployment of the contest infrastructure on GCP. The contest scaled to country-spanning with a record 167 participants.
